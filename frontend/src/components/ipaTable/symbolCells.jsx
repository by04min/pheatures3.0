...
export function DiacriticChip({ item, onRemove, isDragging, onClick, label, widthClass = 'w-14', textClass = 'text-base' }) {
  ...
  return (
    <button
      ...
      className={`${widthClass} h-10 font-mono text-center transition-colors ${
        label ? 'text-[12px] px-0.5' : textClass
      } ${
